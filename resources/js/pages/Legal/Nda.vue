    ...
    <DefaultLayout :inverted="true">
        <div class="relative overflow-hidden bg-white text-black pt-36 sm:pt-44">
            ...
            >
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-black/10 pb-8 dark:border-white/10">
                    <div>
                        <span class="inline-block rounded-md bg-t-blue/10 px-3 py-1 text-xs font-bold tracking-wider text-t-blue uppercase dark:bg-t-blue/20">
                            Právní dokument &bull; Non-Disclosure Agreement (NDA)
                        </span>
                        <h1 class="mt-3 text-3xl font-medium tracking-tight text-slate-950 sm:text-5xl lg:text-6xl dark:text-white leading-tight">
                            Dohoda o mlčenlivosti a ochraně informací
                        </h1>
                        <p class="mt-3 text-sm text-slate-600 sm:text-base dark:text-slate-400">
                ...
                <!-- Document Body -->
                <article class="pt-10 pb-20 text-slate-800 dark:text-slate-200 text-sm sm:text-base leading-relaxed">
                    
                    <!-- Článek I -->
                    <section class="mb-12">
                        <h2 class="mb-5 text-xl font-bold tracking-tight text-slate-950 uppercase sm:text-2xl dark:text-white border-b border-black/10 pb-2 dark:border-white/10">
                            I. Smluvní strany
                        </h2>
                        
                        <p class="mb-6">
                            Smluvní strany uzavírají níže uvedeného dne, měsíce a roku tuto Dohodu o mlčenlivosti, ochraně informací a zákazu jejich zneužití (dále jen „<strong>Dohoda</strong>“):
                        </p>

                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <!-- Poskytovatel -->
                            <div class="rounded-2xl border border-t-blue/30 bg-blue-50/40 p-6 shadow-xs dark:border-t-blue/40 dark:bg-blue-950/20">
                                <div class="text-xs font-bold tracking-wider text-t-blue uppercase">1.1 Poskytovatel</div>
                                <h3 class="mt-1 text-lg font-bold text-slate-950 dark:text-white">Treetino corp s.r.o.</h3>
                                
                                <dl class="mt-4 space-y-2 text-sm">
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">IČO:</dt>
                                        <dd class="font-semibold text-slate-900 dark:text-white">10800107</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">Sídlo:</dt>
                                        <dd class="font-semibold text-slate-900 dark:text-white text-right">Vlčetín 62, Bílá 463 43</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">Zastoupena:</dt>
                                        <dd class="font-semibold text-slate-900 dark:text-white">Dominik Mašek, jednatel</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">Rejstřík:</dt>
                                        <dd class="font-semibold text-slate-900 dark:text-white">KS v Ústí n. L., C 48430</dd>
                                    </div>
                                    <div class="flex justify-between py-1">
                                        <dt class="text-slate-500 dark:text-slate-400">E-mail:</dt>
                                        <dd class="font-semibold text-slate-900 dark:text-white">info@treetino.com</dd>
                                    </div>
                                </dl>

                                <div class="mt-4 text-xs italic text-slate-500 dark:text-slate-400">
                                    (dále jen jako „Poskytovatel“ nebo „Treetino“)
                                </div>
                            </div>

                            <!-- Příjemce -->
                            <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-6 shadow-xs dark:border-slate-800 dark:bg-zinc-900/60">
                                <div class="text-xs font-bold tracking-wider text-emerald-600 uppercase dark:text-emerald-400">1.2 Příjemce (Partner / Prodejce)</div>
                                <h3 class="mt-1 text-lg font-bold text-slate-950 dark:text-white">Obchodní zástupce / Partner</h3>
                                
                                <dl class="mt-4 space-y-2 text-sm">
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">Firma / Jméno:</dt>
                                        <dd class="font-mono text-xs text-slate-500 italic dark:text-slate-400">[ Vyplní obchodní partner ]</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">IČO / RČ / Dat. nar.:</dt>
                                        <dd class="font-mono text-xs text-slate-500 italic dark:text-slate-400">[ Vyplní obchodní partner ]</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">DIČ (plátce DPH):</dt>
                                        <dd class="font-mono text-xs text-slate-500 italic dark:text-slate-400">[ Vyplní obchodní partner ]</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">Sídlo / Bydliště:</dt>
                                        <dd class="font-mono text-xs text-slate-500 italic dark:text-slate-400">[ Vyplní obchodní partner ]</dd>
                                    </div>
                                    <div class="flex justify-between border-b border-black/5 py-1 dark:border-white/5">
                                        <dt class="text-slate-500 dark:text-slate-400">Zastoupen(a):</dt>
                                        <dd class="font-mono text-xs text-slate-500 italic dark:text-slate-400">[ Vyplní obchodní partner ]</dd>
                                    </div>
                                    <div class="flex justify-between py-1">
                                        <dt class="text-slate-500 dark:text-slate-400">E-mail & Tel.:</dt>
                                        <dd class="font-mono text-xs text-slate-500 italic dark:text-slate-400">[ Vyplní obchodní partner ]</dd>
                                    </div>
                                </dl>
                    ...
                    <!-- Podpisová doložka -->
                    <section class="mt-16 rounded-2xl border border-black/10 bg-stone-50/70 p-6 sm:p-8 dark:border-white/10 dark:bg-stone-900/40">
                        ...
                        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
                            <!-- Poskytovatel -->
                            <div class="rounded-xl border border-black/10 bg-white p-5 dark:border-white/10 dark:bg-zinc-950">
                                <div class="text-xs font-bold tracking-wider text-slate-500 uppercase">Za Poskytovatele</div>
                                <div class="mt-2 text-base font-bold text-slate-950 dark:text-white">Treetino corp s.r.o.</div>
                                <div class="mt-1 text-xs text-slate-500">V Bílé / Praze dne 21. 7. 2026</div>

                                <div class="my-6 flex h-20 items-center justify-center rounded-lg border border-dashed border-black/20 bg-slate-50 dark:border-white/20 dark:bg-zinc-900">
                                    <img src="/img/legal/dominik-signature.png" class="h-12 w-auto object-contain dark:invert" alt="Podpis Dominik Mašek" />
                                </div>

                                <div class="text-sm font-semibold text-slate-900 dark:text-white">Dominik Mašek</div>
                                <div class="text-xs text-slate-500">Jednatel, Treetino corp s.r.o.</div>
                            </div>

                            <!-- Partner -->
                            <div class="rounded-xl border border-black/10 bg-white p-5 dark:border-white/10 dark:bg-zinc-950">
                                <div class="text-xs font-bold tracking-wider text-slate-500 uppercase">Za Příjemce</div>
                                <div class="mt-2 text-base font-bold text-slate-950 dark:text-white">Obchodní partner / Prodejce</div>
                                <div class="mt-1 text-xs text-slate-500">V ............................ dne ............................</div>

                                <div class="my-6 flex h-20 items-center justify-center rounded-lg border border-dashed border-black/20 bg-slate-50 text-xs font-medium text-slate-400 dark:border-white/20 dark:bg-zinc-900">
                                    [ Vlastnoruční / Digitální podpis ]
                                </div>

                                <div class="text-sm font-semibold text-slate-900 dark:text-white">Jméno a příjmení: ........................................</div>
                                <div class="text-xs text-slate-500">Funkce / Oprávnění: ........................................</div>
                            </div>
                        </div>

                        <!-- Bottom Download CTA -->
                        <div class="mt-10 flex flex-wrap items-center justify-center gap-4 pt-6 border-t border-black/10 dark:border-white/10 print:hidden">
                            <a
                                href="/legal/nda/download?lang=en"
