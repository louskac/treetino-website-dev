...
def draw_page_7_dashboard(c: canvas.Canvas, data: dict, assets_path: str):
    ...
    try:
        pdfmetrics.registerFont(TTFont("Roboto-Italic", "backend/app/fonts/Roboto-Italic.ttf"))
...
if __name__ == "__main__":
    ...
    draw_page_7_dashboard(c, {}, "backend/app/assets")
    c.save()
    with open("page7_test.pdf", "wb") as f:
        f.write(buffer.getvalue())
    print("Saved page7_test.pdf")
