...
new_func = """def draw_page_6(c: canvas.Canvas, data: dict, assets_path: str):
    ...
    c.setFont("Roboto-Bold", 8)
    c.drawString(130, card_y + card_h - 25, "Kontaktní osoba")
    c.setFillColor(TEXT_COLOR)
    c.drawString(130, card_y + card_h - 37, "Dominik Mašek")
    c.setFont("Roboto", 8)
    c.setFillColor(MUTED_COLOR)
    c.drawString(130, card_y + card_h - 49, "+420 730 587 857")
    c.setFillColor(ACCENT_COLOR)
    c.drawString(130, card_y + card_h - 61, "info@wattino.eu")
    
    c.setFont("Roboto-Bold", 8)
    c.setFillColor(MUTED_COLOR)
    c.drawString(240, card_y + card_h - 25, "Kancelář")
    c.setFont("Roboto", 8)
    c.setFillColor(TEXT_COLOR)
    c.drawString(240, card_y + card_h - 37, "Vlčetin 62, Bílá 463 43")
    c.setFillColor(MUTED_COLOR)
    c.drawString(240, card_y + card_h - 49, "IČ: 10800107")
    ...
    c.setFillColor(TEXT_COLOR)
    c.drawRightString(435, row_y - 5, format_czk(final_price))
    ...
    c.linkURL(link_url, (W/2 - 80, 50, W/2 + 80, 75), relative=1)
...
print("Updated pdf_generator.py with corrected layout and background")
