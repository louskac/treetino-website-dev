...
new_func = """def draw_page_6(c: canvas.Canvas, data: dict, assets_path: str):
    ...
    # Draw simple logo block inside the card
    c.setFillColor(colors.HexColor("#f8fafc"))
    c.roundRect(55, card_y + card_h - 65, 45, 45, 8, fill=1, stroke=0)
    c.setFont("Roboto-Bold", 16)
    c.setFillColor(colors.HexColor("#0f172a"))
    c.drawCentredString(55 + 22.5, card_y + card_h - 50, "T")
    
    c.setFillColor(TEXT_COLOR)
    c.setFont("Roboto-Bold", 11)
    c.drawString(55, card_y + card_h - 85, "Treetino corp s.r.o.")
    c.setFont("Roboto", 9)
    c.setFillColor(MUTED_COLOR)
    c.drawString(55, card_y + card_h - 100, "Česká republika")
...
print("Updated pdf_generator.py with new draw_page_6")
