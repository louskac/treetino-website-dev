<template>
    <Transition name="mobile-card-slide" appear>
        ...
        >
            <div
                class="pointer-events-none absolute -top-12 -right-12 h-40 w-40 rounded-full bg-t-accent/30 blur-3xl"
            ></div>
            <div
                class="pointer-events-none absolute top-1/2 -left-10 h-36 w-36 -translate-y-1/2 rounded-full bg-cyan-300/20 blur-3xl"
            ></div>
            <div
                class="pointer-events-none absolute right-6 -bottom-14 h-40 w-40 rounded-full bg-blue-400/25 blur-3xl"
            ></div>
            <div
                class="pointer-events-none absolute inset-0 bg-linear-to-b from-white/8 via-transparent to-black/20"
            ></div>

            <div
                class="relative z-10 flex items-center justify-between px-5 pt-5"
            >
                <span
                    class="text-[0.65rem] font-medium tracking-[0.18em] text-white/60"
                >
            ...
            <Transition name="mobile-card-content" mode="out-in">
                <div
                    ...
                    class="relative z-10 flex flex-1 flex-col px-5 py-4"
                >
                    <div class="flex flex-row items-center gap-3">
                        <h2
                            class="text-2xl leading-tight font-bold text-white drop-shadow-sm"
                        >
