<template>
    <a
        v-if="href"
        :href="href"
        class="inline-flex items-center justify-center rounded-xl bg-t-blue px-2 text-center font-medium text-white transition-all hover:bg-t-blue/90 cursor-pointer sm:px-3 lg:px-4"
        :class="
            variant === 'slim'
